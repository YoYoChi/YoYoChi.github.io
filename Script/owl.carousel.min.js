function ChangeCenter(){
	...
	$('.owl-item.active').eq(media_report_center).find('a').addClass('hovered');
	$('.owl-item.active').eq(media_report_center).siblings().find('a').removeClass('hovered');
	var i = $('.owl-item').index($('.owl-item.active').eq(media_report_center))-media_report_num;
	if(i>$('.report_line_description:last-child').index()){
		i = i - $('.report_line_description:last-child').index()-1;
	}
	$('.report_line_description').each(function(){
		if($(this).index()!=i){
...
function ChangeMobileCenter(){

	$('.owl-item.active').find('a').addClass('hovered');
	var i = $('.owl-item').index($('.owl-item.active'))-media_report_num+1;
	if(i>$('.report_line_description:last-child').index()){
		i = i - $('.report_line_description:last-child').index()-1;
	}
	new_des = $('.report_line_description').eq(i);
	new_des.addClass('active') ;
	new_des.siblings().removeClass('active');
}
...
if(width<768){ChangeMobileCenter()}else{ChangeCenter()}
